...
export function DictationPanel() {
    ...
    return (
      <div className="flex flex-col items-center justify-center gap-8 py-12">
        <div className="relative">
          <div className="rounded-full bg-muted/50 p-8 shadow-sm">
            <Mic className="h-16 w-16 text-muted-foreground/60" />
          </div>
        </div>
        <div className="text-center space-y-3 max-w-sm">
          ...
          <p className="text-sm text-muted-foreground">
            Vox needs audio access to translate speech into clean, copyable text.
          </p>
        </div>
  ...
  if (permissionStatus === "denied") {
    return (
      <div className="flex flex-col items-center justify-center gap-8 py-12">
        ...
        <div className="text-center space-y-3 max-w-sm">
          <h2 className="text-2xl font-semibold font-serif">Access blocked</h2>
          <p className="text-sm text-muted-foreground">
  ...
  return (
    <div className="flex flex-col items-center gap-10">
      ...
      {/* Error message */}
      {error && (
        <div className="flex items-center gap-2 rounded-2xl bg-destructive/10 px-4 py-3 text-sm text-destructive max-w-md">
